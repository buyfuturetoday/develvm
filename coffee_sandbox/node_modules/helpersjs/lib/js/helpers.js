/*jshint -W054, -W117, evil:true, devel:true, browser:true*/
(function(exports) {
...
// In browsers:
//---------------
// <script type="text/javascript" src="https://raw.github.com/colmsjo/helpersjs/master/lib/js/helpers.js"></script>
// ...
...
//------------------------------
    ...
    exports.create = function() {
        ...
        return {
            ...
            isset: function(a){
                if (a !== undefined && a !== null && typeof a.length !== undefined) {
                    return (a.length !== 0);
                }
            ...
            signString : function (stringToSign, secret) {
                ...
                // Generate the hash
                var sha = (typeof exports !== 'undefined') ? require('node-sha256') : this;
                var shaObj = new sha.jsSHA(stringToSign, "ASCII");

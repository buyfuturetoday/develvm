' Compile in mono: vbnc test.vb /d:Mono=True
...
Module Test
    ...
    Sub parse_test1()
        ...
        'Debug.Print "Value:" & json.Count & TypeName(json)
        Debug.Print 'Value:'
    ...
    Sub parse_test4()
        ...
        Set json = lib.parse("[{""type"":""t1"",""title"":""___1"",""attr"":[""1-1"",""1-2""]},{""type"":""t2"",""title"":""___2"",""attr"":[""2-1"",""2-2""]}]")"]}]")
        Debug.Assert Err.Number = 0
